...
export default function YoutubeLink({className, width="60", height="60", fill = "#FF3D00", href = "https://youtube.com"}) {

    return (<>
        <Link
            className={className}
            href={href}>
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width={width} height={height}
                 viewBox="0 0 48 48">
                <path fill={fill}
