export default function ImprovingLogo({id = "improvingLogo",width = 300, height = 300, className, click}) {
        ...
        <>
            ...
            >
                ...
                <g><g>
                    ...
                    {/*this is the ray section*/}
                    {/*i have to label the rays as they are not in a bottom left to top right order*/}
                    <g transform="scale(.60,.60) translate(255, 65)">
                        {/*6th ray*/}
                        <path fill="#00A4E4"
