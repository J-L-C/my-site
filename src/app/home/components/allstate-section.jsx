...
export default function AllstateSection({className}) {
    ...
    return (<>
        <div className="mt-16">
            <div className="sm:mx-[21%] mx-[25%]">
                <AllstateLogo
                    onClick={onClick}
                    className="sm:w-96 w-64 mt-4 "
                    width="400"
                    height="150"
                />
            </div>
            <div className="text-white p-8 text-justify bg-[#0959be]">
                ...
                <p>
                    ...
                    Galvanize.
                    From there, I worked with some amazing engineers and we built a product (Web API) that made it easier to
                    access claim data for teams inside of Allstate. After that was launched, I was fortunate enough to
                    travel to
                    Northern Ireland to hand it off to the lab there. After that fortunate journey, I joined another team
                    to deliver
                    a product that streamlined how adjusters requested 3rd party services. This involved integrating
                    our application with several external vendors with different levels of technical maturity to
